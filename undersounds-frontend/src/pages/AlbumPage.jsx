  ...
  return (
    <Box
      sx={{
        ...
        alignItems: "center",
        position: "relative", // Necesario para posicionar los elementos encima
    ...
    >
      ...
      <Box
        sx={{
          ...
          right: 0,
          bottom: 0,
          backgroundImage: `url(${album.coverImage})`, // Usa la imagen de fondo
          backgroundSize: "cover",
          backgroundPosition: "center",
          filter: "blur(8px)", // Aplica el desenfoque a la imagen
          zIndex: -1, // Asegura que la capa no se interponga con el contenido
        }}
      />
          ...
          <Grid container spacing={2}>
            {tracks.map((track) => (
              <Grid item xs={12} key={track.id}>
                ...
                >
                  <Typography variant="subtitle1" sx={{ fontWeight: "medium",marginRight: "auto",  }}>
                  ...
                  <Button
                    ...
                    sx={{
                      mt: 1,
                      backgroundColor: "#1DA0C3", // Fondo azul para el botón
                      borderColor: "#1DA0C3", // Borde azul
                      color: "white", // Color blanco para el ícono
                      textTransform: "none",
                      px: 2, // Aumentar padding horizontal para dar más espacio a los íconos
                      py: 2, // Aumentar padding vertical para hacer el botón más grande
                      borderRadius: "50%", // Hace el botón redondo
                      "&:hover": {
                        backgroundColor: "#1976d2", // Cambiar a un azul más oscuro al pasar el mouse
                        borderColor: "#1976d2", // Borde más oscuro
                      },
                      marginLeft: "auto", // Empujar el botón a la derecha
                      minWidth: "60px", // Establecer un ancho mínimo para el botón
                    }}
                    startIcon={<PlayArrowIcon sx={{ size:"60px", color: "white",   }} />} // Aumentar el tamaño del ícono a 40px
                    onClick={() => {
                      if (!user) {
